...
Старый модуль `app/modules/modman` продолжает работать. Новый `modman` сосуществует с ним:
...
## Фаза 11. Тестовые пакеты (после готовности modman)
- [ ] `yii2-cms-shortcode-new` (эталонная конверсия, минимальный модуль)
- [ ] `yii2-cms-blog-new`
- [ ] `yii2-cms-person-new`
- [ ] Регистрация modman в приложении + подключение `_new`-артефактов (additively)
