 ...
 *
 * Пересборка всех артефактов есть в `modmanNew/modules/recompile`; здесь — точечные операции по меню:
 *  - `php yii modmanNew/menu/info`    — состояние локаций меню (вкл/выкл, файл, существование, число пунктов);
